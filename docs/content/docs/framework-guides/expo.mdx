...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    Install the component, Better Auth, and ensure the latest version
    of Convex.

    <Callout>This component requires Convex `1.25.0` or later.</Callout>

    ```npm
    npm install convex@latest @convex-dev/better-auth better-auth@~1.3.24 @better-auth/expo@~1.3.24
    ```
