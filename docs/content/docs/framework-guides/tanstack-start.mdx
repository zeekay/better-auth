...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    Configure a set of helper functions for authenticated SSR and handlers.
...
rendering, server functions, or any other TanStack Start server code, use Convex
functions and call the function from your server code.

Here's an example Convex function that uses Better Auth's server methods, and a
TanStack server function that calls the Convex function.
