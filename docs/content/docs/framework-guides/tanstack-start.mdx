...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    npm install better-auth@1.3.26 --save-exact
    ```
  ...
  <div className="fd-step">
    ...
    import { createFileRoute } from '@tanstack/react-start/server'

    export const ServerRoute = createFileRoute('/api/auth/$').methods({
      server: {
        handlers: {
          GET: ({ request }) => {
